                            ...
                            <Grid item xs={6} className={style.root} >
                                <Stack spacing={2}>
                                    <Stack direction="row" alignItems="center" spacing={3}>
                                        <Stack className={style.name}>{tmdbMovieInfo.name}</Stack>
                                    ...
                                    <Stack direction="row" spacing={2}>
                                        ...
                                        <Stack direction="row"  spacing={2} py={1}>
                                            {tmdbMovieInfo.genres.map((genre, key) => (
                                                <Stack key={key} className={style.category_button} onClick={() => {
                                    ...
                                    <Stack direction="row" spacing={2}>
                                        ...
                                        <Stack className={style.box}>
                                            <Stack className={style.title}>EPISODE RUNTIME</Stack>
                                            <Stack className={style.content}>{runtime}</Stack>
                                        </Stack>
                                        <Stack className={style.box}>
                                            <Stack className={style.title}>NUMBER OF SEASONS</Stack>
                                            <Stack className={style.content}>{tmdbMovieInfo.number_of_seasons}</Stack>
                                        </Stack>
                                        <Stack className={style.box}>
                                            <Stack className={style.title}>NUMBER OF EPISODES</Stack>
                                            <Stack className={style.content}>{tmdbMovieInfo.number_of_episodes}</Stack>
                                        </Stack>
                                        <Stack className={style.box}>
                                            <Stack className={style.title}>EPISODE RUNTIME</Stack>
                                            <Stack className={style.content}>{runtime}</Stack>
                                    ...
                                    <Stack textAlign="left">
                                        ...
                                        <Stack className={style.content_overview}>{tmdbMovieInfo.overview}</Stack>
                                    </Stack>
